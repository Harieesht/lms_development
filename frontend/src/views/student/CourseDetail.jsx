...
function CourseDetail() { 
  ...
  return (
    <>
                              ...
                              <div className="">
                                ...
                                <div className=" p-0 pt-3">
                                  <div className="vstack gap-3 p-3"> 
                                    ...
                                    <div className="shadow rounded-3 p-3 bg-light" key={id}>
                                      <div className="d-sm-flex justify-content-sm-between mb-3">
                                        <div className="d-flex align-items-center">
                                          <div className="avatar avatar-sm flex-shrink-0">
                                            <img
                                      ...
                                      <button className='btn btn-primary btn-sm mb-3 mt-3' onClick={() => {
      ...
      <Modal show={ConversationShow} size='lg' onHide={handleConversationClose}>
        <Modal.Header closeButton>
          <Modal.Title>Conversions</Modal.Title>
        </Modal.Header>
        <Modal.Body>
          ...
          <div className="border p-2 p-sm-4 rounded-3">
                    ...
                    <div className="bg-light p-3 rounded w-100">
                      <div className="d-flex w-100 justify-content-center">
                        <div className="me-2 ">
                          ...
                          <p className="mb-0 mt-3">{post?.answer}
                          </p>
            ...
            <form class="w-100" >
              <textarea name='message' class="one form-control pe-4 mb-2 bg-light" id="autoheighttextarea" rows="5" placeholder="Post your Message here " onChange={(e) => {setPostMessage(e.target.value)}}></textarea>
              <button class="btn btn-primary mb-0 w-25" type="button" onClick={handlePostMessage}>Post <i className='fas fa-paper-plane'></i></button>
            </form>
        ...
        <Modal.Body>
          <form onSubmit={handleAddQuestionSubmit} > 
            ...
            <button type="submit" className="btn btn-primary" >
              Ask Question <i className="fas fa-check-circle"></i>
            </button>
          </form>
        </Modal.Body>
      </Modal>
